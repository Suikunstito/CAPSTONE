...
class ProductoForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "sin_stock": forms.CheckboxInput(attrs={"class": "form-check-input"}),
            "categoria1": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Categoría principal"}
            ),
            "categoria2": forms.TextInput(
                attrs={
                    "class": "form-control",
                    "placeholder": "Categoría secundaria (opcional)",
                }
            ),
            "ahorro": forms.NumberInput(
                attrs={
                    "class": "form-control",
                    "placeholder": "0.00",
                    "step": "0.01",
            ...
            "ahorro_percent": forms.NumberInput(
                attrs={
                    "class": "form-control",
                    "placeholder": "0",
                    "step": "1",
    ...
    def clean(self):
        ...
        if oferta and not low_price:
            self.add_error(
                "low_price", "Debes especificar un precio bajo para productos en oferta"
            )
