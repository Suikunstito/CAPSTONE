...
class ProductosAdmin(admin.ModelAdmin):
    ...
    list_filter = ["oferta", "sin_stock", "categoria1", "brand"]

    search_fields = ["title", "brand", "categoria1", "categoria2"]

    readonly_fields = ["id_producto", "datetime", "ahorro", "ahorro_percent"]

    fieldsets = (
        ("Información Básica", {"fields": ("id_producto", "title", "brand")}),
        ("Precios", {"fields": ("normal_price", "low_price", "high_price")}),
        (
        ...
        ("Categorización", {"fields": ("categoria1", "categoria2")}),
        ("Estado y Stock", {"fields": ("sin_stock", "kilo")}),
        (
            "Metadatos",
            {
