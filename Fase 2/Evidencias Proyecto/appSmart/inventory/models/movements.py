...
class StgProductosRaw(models.Model):
    ...
    brand = models.CharField(
        max_length=4000, db_collation="Modern_Spanish_CI_AS", blank=True, null=True
    )
    normal_price = models.CharField(
        max_length=100, db_collation="Modern_Spanish_CI_AS", blank=True, null=True
    )
    ...
    categoria1 = models.CharField(
        max_length=4000, db_collation="Modern_Spanish_CI_AS", blank=True, null=True
    )
    categoria2 = models.CharField(
        max_length=4000, db_collation="Modern_Spanish_CI_AS", blank=True, null=True
    )
    ...
    sin_stock = models.CharField(
        max_length=50, db_collation="Modern_Spanish_CI_AS", blank=True, null=True
    )
    page = models.CharField(
        max_length=50, db_collation="Modern_Spanish_CI_AS", blank=True, null=True
    )
    ahorro = models.CharField(
        max_length=100, db_collation="Modern_Spanish_CI_AS", blank=True, null=True
    )
    ahorro_percent = models.CharField(
        max_length=100, db_collation="Modern_Spanish_CI_AS", blank=True, null=True
    )
    kilo = models.CharField(
        max_length=100, db_collation="Modern_Spanish_CI_AS", blank=True, null=True
    )
