...
urlpatterns = [
    ...
    path(
        "informes/reporte-compras.csv",
        views.exportar_reporte_compras,
        name="reporte_compras_csv",
    ),
    path(
        "informes/resumen-stock.csv",
        views.exportar_reporte_stock,
        name="reporte_stock_csv",
    ),
]
